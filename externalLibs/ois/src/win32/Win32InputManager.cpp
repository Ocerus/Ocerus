...
//----------------------------------------------------------------------------//
Object* Win32InputManager::createObject(InputManager* creator, Type iType, bool bufferMode, const std::string & vendor, const bool fullscreen)
{
	Object *obj = 0;
	...
	{
		if( mouseUsed == false )
			obj = new Win32Mouse(this, mDirectInput, bufferMode, mouseSettings, fullscreen);
		break;
	}
	case OISJoyStick:
	{
