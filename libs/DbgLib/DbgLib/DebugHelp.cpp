...
const uintx CDebugHelp::m_DumpTypeConverter[] = 
{
	(MiniDumpNormal),
...
uintx CDebugHelp::m_DumpType = CDebugHelp::m_DumpTypeConverter[CDebugHelp::MiniDump];
...
//////////////////////////////////////////////////////////////////////////
void CSymbolResolver::ResolveSymbol(uintx p_Address, tstring& p_Function, tstring& p_File, uintx& p_Line)
{
#if defined(PLATFORM_WINDOWS)
	...
	static const uintx MaxSymFuncNameLen = 1024;
...
void CSymbolResolver::ResolveSymbol(uintx p_Address, ModuleHandle p_hModule, const tchar* p_ModuleName, tstring& p_Function, tstring& p_File, uintx& p_Line)
{
#if defined(PLATFORM_WINDOWS)
	// check module
