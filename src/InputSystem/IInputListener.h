...
namespace InputSystem
{
	...
	public:
		...
		virtual bool KeyPressed(const InputSystem::KeyInfo& ke) { return false; }

		/// Called when a keyboard key is released.
		/// If true is returned the even will not be processed further.
		virtual bool KeyReleased(const InputSystem::KeyInfo& ke) { return false; }

		/// Called when the mouse moves. Cursor position and other info is passed via parameter.
		/// If true is returned the even will not be processed further.
		virtual bool MouseMoved(const InputSystem::MouseInfo& mi) { return false; }

		/// Called when a mouse button is pressed. Cursor position and other info is passed via parameter.
		/// If true is returned the even will not be processed further.
		virtual bool MouseButtonPressed(const InputSystem::MouseInfo& mi, const InputSystem::eMouseButton btn) { return false; }

		/// Called when a mouse button is released. Cursor position and other info is passed via parameter.
		/// If true is returned the even will not be processed further.
		virtual bool MouseButtonReleased(const InputSystem::MouseInfo& mi, const InputSystem::eMouseButton btn) { return false; }
