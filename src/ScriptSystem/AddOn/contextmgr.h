/// @file
/// The CContextMgr is a class designed to aid the management of multiple simultaneous scripts
/// executing in parallel. It supports both concurrent script threads and co-routines.
