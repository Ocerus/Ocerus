...
PROPERTY_TYPE(PT_STRING, string, string(), "string", Object)
...
PROPERTY_TYPE(PT_COLOR, GfxSystem::Color, GfxSystem::Color::Null, "Color", Object)
#ifndef SCRIPT_ONLY
PROPERTY_TYPE(PT_RESOURCE, ResourceSystem::ResourcePtr, 0, "ResourcePtr", Object)
