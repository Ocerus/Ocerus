...
namespace GUISystem {
	...
	{		
		...
		conv_texture_rect.x = (texture_rect.d_left != HUGE_VAL)?round(texture_rect.d_left*conv_tex->GetWidth(false)):0;
		conv_texture_rect.y = (texture_rect.d_top != HUGE_VAL)?round(texture_rect.d_top*conv_tex->GetHeight(false)):0;
		conv_texture_rect.w = (texture_rect.d_right != HUGE_VAL)?round(texture_rect.d_right*conv_tex->GetWidth(false) - texture_rect.d_left*conv_tex->GetWidth(false)):conv_tex->GetWidth(false);
		conv_texture_rect.h = (texture_rect.d_bottom != HUGE_VAL)?round(texture_rect.d_bottom*conv_tex->GetHeight(false) - texture_rect.d_top*conv_tex->GetHeight(false)):conv_tex->GetHeight(false);
