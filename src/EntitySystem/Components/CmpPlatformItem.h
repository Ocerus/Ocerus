...
{
	/// @name Represents an item placed on the top of a platform.
	...
	public:
		...
		//@}
		/// @name Platform which houses this item.
		//@{
		...
		//@}
		/// @name Engine type of this specific engine. Holds some useful params.
		//@{
		...
		//@}
		/// @name Position relative to the parent platform.
		//@{
