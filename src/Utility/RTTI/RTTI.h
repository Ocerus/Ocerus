...
public:
	...
	CRTTI(	uint8 dwStub, ClassID CLID, const char* szClassName, CRTTI* pBaseClassRTTI, 
...
inline std::list<CAbstractProperty*>::iterator CRTTI::GetFirstProperty()
{
	return m_Properties.begin();
}

inline std::list<CAbstractProperty*>* CRTTI::GetProperties()
{
	return &m_Properties;
}
...
inline std::list<CAbstractProperty*>::iterator CRTTI::GetLastProperty()
{
