...
The first thing that needs to be done is creating a new component class. Each component class is defined in a separate header file, which are located in \emph{EntitySystem/Components}.
