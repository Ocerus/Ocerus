...
\item
The third parameter defines type and C++ name of the function. When the function is a method of some class (as in this example), then \emph{asMETHODPR} macro is used with parameters: name of class, name of method, parameter types and return type.
\item
...
If a constructor or a destructor are needed, they shall be registered the following way:
