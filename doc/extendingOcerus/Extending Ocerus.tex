...
\item
Static \emph{CreateMe()} method. Returns a special shared pointer (\emph{ResourceSystem::ResourcePtr}) that points to the new resource class instance. This pointer allows type-checked casting to specific resource pointers. So it should look like this:
