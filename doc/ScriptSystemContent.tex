...
The only registered global function is \verb/void Log(string& message)/ that prints the string in the parameter to the log so it is useful for debugging scripts. For a complete reference of registered classes, global functions etc. see ScriptRegister.pdf.
