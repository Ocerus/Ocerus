...
\begin{table}[htbp]
	\centering
		...
		\begin{tabular}{|p{0.20\hsize}|p{0.73\hsize}|}
			...
			\hline
			Texture & a bitmap picture (jpeg, png, bmp, psd, dds, hdr, tga)\\
			Mesh & a 3D object (obj)\\
			CEGUI & a GUI related resource (layout, scheme, font, imageset, looknfeel)\\
