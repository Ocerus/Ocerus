...
In the following sections the interface of the string manager will be described as well as loading and formatting the desired localized text. In the last section there is a small glossary of used terms.
