...
component part of the \textbf{Entity} view. These properties are defined in the script and they allow you to
control the scripted behavior. In our script, there are two properties: \textbf{LeftSided} and
\textbf{Pivot}. The \textbf{LeftSided} property determines which flipper is the left one and which is the
other one and the \textbf{Pivot} property defines the location of the pivot point.
